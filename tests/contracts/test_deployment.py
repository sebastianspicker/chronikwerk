"""Verify the single-process Docker and systemd deployment contract."""
...
def test_deployment_app_creates_with_settings(tmp_path: Path) -> None:
...
def test_deployment_dockerfile_exists() -> None:
