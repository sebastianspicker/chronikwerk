"""Verifies ticket path and username selection reject invalid archive metadata."""

from __future__ import annotations

import pytest

from chronikwerk.adapters.zammad.models import Ticket, UserRef
...
def _ticket(
    *,
    ...
    """Build a representative ticket fixture."""
