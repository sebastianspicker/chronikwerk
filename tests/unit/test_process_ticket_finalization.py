...
def _request(client: object) -> ticket_pipeline_module.TicketPipelineRequest:
    """Build the internal pipeline contract used by success-path stages."""
    return ticket_pipeline_module.TicketPipelineRequest(
