"""Verifies Zammad client resource operations, response bounds, and DNS revalidation."""
...
import chronikwerk.adapters.zammad.client as zammad_client_module
...
def test_test_runtime_can_explicitly_allow_a_private_fixture() -> None:
    async def run() -> None:
        async with AsyncZammadClient(
            base_url="https://127.0.0.1",
            api_token="test-token",
            _runtime=_test_runtime(allow_private_networks=True),
        ):
            pass
