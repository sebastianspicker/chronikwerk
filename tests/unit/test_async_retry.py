"""Verifies async retry attempts, backoff timing, and exhaustion behavior."""
...
def test_succeeds_first_attempt() -> None:
    ...
    async def run() -> None:
        ...
        with patch("chronikwerk.app.jobs.async_retry.asyncio.sleep") as mock_sleep:
...
def test_exhausts_retries() -> None:
    ...
    async def run() -> None:
        ...
        with (
            patch("chronikwerk.app.jobs.async_retry.asyncio.sleep") as mock_sleep,
