"""Verifies token-bucket limits, eviction, and client-key extraction."""
...
from chronikwerk.app.middleware.rate_limit import (
    RateLimitMiddleware,
    _client_key,
...
def _make_settings_with_rate_limit(*, enabled: bool, rps: float, burst: int) -> Any:
    """Build the settings with rate limit fixture used by this scenario."""
