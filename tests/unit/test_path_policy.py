"""Verifies archive-path normalization rejects traversal and unsafe Unicode forms."""
...
from chronikwerk.adapters.storage.layout import build_target_dir
from chronikwerk.domain.path_policy import (
    ensure_within_root,
    sanitize_segment,
    validate_segments,
)
