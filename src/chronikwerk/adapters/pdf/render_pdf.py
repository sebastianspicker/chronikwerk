"""Render ticket snapshots as deterministic, accessible PDFs through WeasyPrint."""
...
from chronikwerk.adapters.pdf.url_fetcher import _safe_url_fetcher
...
def _template_folder_path() -> Generator[Path]:
    traversable = resources.files("chronikwerk").joinpath("templates", DEFAULT_TEMPLATE_NAME)
