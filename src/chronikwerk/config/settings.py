"""Compose validated settings while preserving the public configuration API."""
...
from chronikwerk.config._settings_sections import (
    AdminSettings,
    AdmissionSettings,
    BodySizeLimitSettings,
    FieldsSettings,
    HardeningSettings,
    ...
    ServerSettings,
    StorageSettings,
    TransportHardeningSettings,
    WebhookHardeningSettings,
    WorkflowSettings,
)
from chronikwerk.config._settings_signing import (
    SigningPadesSettings,
    SigningSettings,
    SigningTimestampRfc3161Settings,
    SigningTimestampSettings,
)
from chronikwerk.config._settings_zammad import (
...
# These definitions historically lived in this module. Keep their documented
# reflection and pickle path stable while their implementations remain private.
for _public_setting_type in (
    AdminSettings,
    AdmissionSettings,
    BodySizeLimitSettings,
    FieldsSettings,
    ...
    _public_setting_type.__module__ = __name__
canonicalize_zammad_origin.__module__ = __name__
