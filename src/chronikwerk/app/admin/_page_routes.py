...
from chronikwerk.app.admin.auth import (
    SESSION_COOKIE,
    access_token_matches,
    csrf_token_matches,
    session_from_request,
)
from chronikwerk.app.jobs.history import read_history
...
async def admin_css() -> Response:
    ...
    data = resources.files("chronikwerk").joinpath("static/admin/admin.css").read_bytes()
...
async def admin_javascript() -> Response:
    ...
    data = resources.files("chronikwerk").joinpath("static/admin/admin.js").read_bytes()
...
async def brand_mark() -> Response:
    ...
    data = resources.files("chronikwerk").joinpath("static/admin/chronikwerk-mark.svg").read_bytes()
