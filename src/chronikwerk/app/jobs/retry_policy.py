"""Classify failures and calculate bounded retry delays for job processing."""
...
from chronikwerk.domain.error_messages import (
    ErrorMessages,
    format_fs_error,
    format_http_error,
)
from chronikwerk.domain.errors import PermanentError, TransientError, wrap_exception
