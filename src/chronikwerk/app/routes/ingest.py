"""Accept, authenticate, and schedule Zammad webhook deliveries."""
...
from chronikwerk.app.constants import (
    DELIVERY_ID_HEADER,
    FORCE_REPROCESS_KEY,
    REQUEST_ID_KEY,
)
...
from chronikwerk.app.jobs.shutdown import is_shutting_down, track_task
...
async def batch_ingest(
    ...
    if not _schedule_batch(jobs, settings=settings, admission=admission):
        return _overload_error()
