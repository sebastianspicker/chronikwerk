"""Compose the FastAPI application, routes, middleware, and lifecycle hooks."""
...
from chronikwerk.app.admin.auth import AdminSessionStore
...
from chronikwerk.app.jobs.shutdown import (
    clear_shutting_down,
    set_shutting_down,
    wait_for_tasks,
)
from chronikwerk.app.jobs.ticket_stores import aclose_stores
from chronikwerk.app.middleware.body_size_limit import BodySizeLimitMiddleware
from chronikwerk.app.middleware.hmac_verify import HmacVerifyMiddleware
from chronikwerk.app.middleware.rate_limit import RateLimitMiddleware
from chronikwerk.app.middleware.request_id import (
    _REQUEST_ID_HEADER,
    RequestIdMiddleware,
)
from chronikwerk.app.responses import api_error
from chronikwerk.app.routes.healthz import router as healthz_router
from chronikwerk.app.routes.ingest import router as ingest_router
from chronikwerk.app.routes.jobs import router as jobs_router
from chronikwerk.app.routes.metrics import router as metrics_router
...
def _wire_app(application: FastAPI, *, settings: Settings | None) -> None:
    ...
    if settings is not None and settings.admin.enabled:
        from chronikwerk.app.admin.routes import router as admin_router
